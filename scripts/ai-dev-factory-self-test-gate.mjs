...
const COMMANDS_BASELINE = [
  ...
  { name: "verify-1.0g", cmd: "node packages/db/src/_verify-1.0g.mjs", phase: "1.0g", optional: true },
  ...
  { name: "auto-loop-verify", cmd: "node scripts/ai-company-auto-loop-verify.mjs", phase: "1.0i-loop", optional: true },
  { name: "premerge-simulate", cmd: "node scripts/ai-company-premerge-simulate.mjs", phase: "1.0i-loop", optional: true },
  { name: "verify-1.0j", cmd: "node packages/db/src/_verify-1.0j.mjs", phase: "1.0j", optional: true },
  { name: "vertical-mission-auto-loop", cmd: "node scripts/ai-company-vertical-mission-auto-loop.mjs --mission mission_1_0j_repo_audit --max-iterations 5 --stable-passes 2 --write-report --explain", phase: "1.0j", optional: true },
  ...
  { name: "verify-1.0o", cmd: "node packages/db/src/_verify-1.0o.mjs", phase: "1.0o", optional: true },
  { name: "lead-to-sales-auto-loop", cmd: "node scripts/ai-company-lead-to-sales-auto-loop.mjs", phase: "1.0o", optional: true },
  { name: "lead-to-sales-premerge-simulate", cmd: "node scripts/ai-company-lead-to-sales-premerge-simulate.mjs", phase: "1.0o", optional: true },
  { name: "verify-1.0p", cmd: "node packages/db/src/_verify-1.0p.mjs", phase: "1.0p", optional: true },
  { name: "revenue-command-center-auto-loop", cmd: "node scripts/ai-company-revenue-command-center-auto-loop.mjs", phase: "1.0p", optional: true },
  { name: "revenue-command-center-premerge-simulate", cmd: "node scripts/ai-company-revenue-command-center-premerge-simulate.mjs", phase: "1.0p", optional: true },
  { name: "verify-1.0q", cmd: "node packages/db/src/_verify-1.0q.mjs", phase: "1.0q", optional: true },
  { name: "owner-approval-workbench-auto-loop", cmd: "node scripts/ai-company-owner-approval-workbench-auto-loop.mjs", phase: "1.0q", optional: true },
  { name: "owner-approval-workbench-premerge-simulate", cmd: "node scripts/ai-company-owner-approval-workbench-premerge-simulate.mjs", phase: "1.0q", optional: true },
  { name: "verify-1.0r", cmd: "node packages/db/src/_verify-1.0r.mjs", phase: "1.0r", optional: true },
  { name: "live-action-gateway-auto-loop", cmd: "node scripts/ai-company-live-action-gateway-auto-loop.mjs", phase: "1.0r", optional: true },
  { name: "live-action-gateway-premerge-simulate", cmd: "node scripts/ai-company-live-action-gateway-premerge-simulate.mjs", phase: "1.0r", optional: true },
  { name: "verify-1.0s", cmd: "node packages/db/src/_verify-1.0s.mjs", phase: "1.0s", optional: true },
  { name: "email-sandbox-auto-loop", cmd: "node scripts/ai-company-email-sandbox-auto-loop.mjs", phase: "1.0s", optional: true },
  { name: "email-sandbox-premerge-simulate", cmd: "node scripts/ai-company-email-sandbox-premerge-simulate.mjs", phase: "1.0s", optional: true },
  { name: "verify-1.0t", cmd: "node packages/db/src/_verify-1.0t.mjs", phase: "1.0t", optional: true },
  { name: "email-live-readiness-auto-loop", cmd: "node scripts/ai-company-email-live-readiness-auto-loop.mjs", phase: "1.0t", optional: true },
  { name: "email-live-readiness-premerge-simulate", cmd: "node scripts/ai-company-email-live-readiness-premerge-simulate.mjs", phase: "1.0t", optional: true },
  { name: "verify-1.0u", cmd: "node packages/db/src/_verify-1.0u.mjs", phase: "1.0u", optional: true },
  { name: "email-live-pilot-auto-loop", cmd: "node scripts/ai-company-email-live-pilot-auto-loop.mjs", phase: "1.0u", optional: true },
  ...
  { name: "verify-1.0x", cmd: "node packages/db/src/_verify-1.0x.mjs", phase: "1.0x", optional: true },
  { name: "controlled-outreach-auto-loop", cmd: "node scripts/ai-company-controlled-outreach-auto-loop.mjs", phase: "1.0x", optional: true },
  { name: "controlled-outreach-premerge-simulate", cmd: "node scripts/ai-company-controlled-outreach-premerge-simulate.mjs", phase: "1.0x", optional: true },
  { name: "verify-1.0y", cmd: "node packages/db/src/_verify-1.0y.mjs", phase: "1.0y", optional: true },
  { name: "controlled-outreach-outcome-auto-loop", cmd: "node scripts/ai-company-controlled-outreach-outcome-auto-loop.mjs", phase: "1.0y", optional: true },
  { name: "controlled-outreach-outcome-premerge-simulate", cmd: "node scripts/ai-company-controlled-outreach-outcome-premerge-simulate.mjs", phase: "1.0y", optional: true }
];
...
async function main() {
  ...
  if (!isAll) {
    ...
    } else if (selectedPhase === "1.0i") {
      filteredCommands = COMMANDS_BASELINE.filter(c => c.phase === "0.3j" || c.phase === "0.3k" || c.phase === "0.3l" || c.phase === "0.3m" || c.phase === "0.3n" || c.phase === "0.3o" || c.phase === "0.3p" || c.phase === "0.3q" || c.phase === "0.3r" || c.phase === "0.3s" || c.phase === "1.0a" || c.phase === "1.0b" || c.phase === "1.0c" || c.phase === "1.0d" || c.phase === "1.0e" || c.phase === "1.0f" || c.phase === "1.0g" || c.phase === "1.0h" || c.phase === "1.0i");
    } else if (selectedPhase === "1.0i-loop") {
      filteredCommands = COMMANDS_BASELINE.filter(c => c.phase === "0.3j" || c.phase === "0.3k" || c.phase === "0.3l" || c.phase === "0.3m" || c.phase === "0.3n" || c.phase === "0.3o" || c.phase === "0.3p" || c.phase === "0.3q" || c.phase === "0.3r" || c.phase === "0.3s" || c.phase === "1.0a" || c.phase === "1.0b" || c.phase === "1.0c" || c.phase === "1.0d" || c.phase === "1.0e" || c.phase === "1.0f" || c.phase === "1.0g" || c.phase === "1.0h" || c.phase === "1.0i" || c.phase === "1.0i-loop");
    } else if (selectedPhase === "1.0j") {
    ...
    } else if (selectedPhase === "1.0o") {
      filteredCommands = COMMANDS_BASELINE.filter(c => c.phase === "0.3j" || c.phase === "0.3k" || c.phase === "0.3l" || c.phase === "0.3m" || c.phase === "0.3n" || c.phase === "0.3o" || c.phase === "0.3p" || c.phase === "0.3q" || c.phase === "0.3r" || c.phase === "0.3s" || c.phase === "1.0a" || c.phase === "1.0b" || c.phase === "1.0c" || c.phase === "1.0d" || c.phase === "1.0e" || c.phase === "1.0f" || c.phase === "1.0g" || c.phase === "1.0h" || c.phase === "1.0i" || c.phase === "1.0i-loop" || c.phase === "1.0j" || c.phase === "1.0k" || c.phase === "1.0l" || c.phase === "1.0m" || c.phase === "1.0n" || c.phase === "1.0o");
    } else if (selectedPhase === "1.0p") {
      filteredCommands = COMMANDS_BASELINE.filter(c => c.phase === "0.3j" || c.phase === "0.3k" || c.phase === "0.3l" || c.phase === "0.3m" || c.phase === "0.3n" || c.phase === "0.3o" || c.phase === "0.3p" || c.phase === "0.3q" || c.phase === "0.3r" || c.phase === "0.3s" || c.phase === "1.0a" || c.phase === "1.0b" || c.phase === "1.0c" || c.phase === "1.0d" || c.phase === "1.0e" || c.phase === "1.0f" || c.phase === "1.0g" || c.phase === "1.0h" || c.phase === "1.0i" || c.phase === "1.0i-loop" || c.phase === "1.0j" || c.phase === "1.0k" || c.phase === "1.0l" || c.phase === "1.0m" || c.phase === "1.0n" || c.phase === "1.0o" || c.phase === "1.0p");
    } else if (selectedPhase === "1.0q") {
      filteredCommands = COMMANDS_BASELINE.filter(c => c.phase === "0.3j" || c.phase === "0.3k" || c.phase === "0.3l" || c.phase === "0.3m" || c.phase === "0.3n" || c.phase === "0.3o" || c.phase === "0.3p" || c.phase === "0.3q" || c.phase === "0.3r" || c.phase === "0.3s" || c.phase === "1.0a" || c.phase === "1.0b" || c.phase === "1.0c" || c.phase === "1.0d" || c.phase === "1.0e" || c.phase === "1.0f" || c.phase === "1.0g" || c.phase === "1.0h" || c.phase === "1.0i" || c.phase === "1.0i-loop" || c.phase === "1.0j" || c.phase === "1.0k" || c.phase === "1.0l" || c.phase === "1.0m" || c.phase === "1.0n" || c.phase === "1.0o" || c.phase === "1.0p" || c.phase === "1.0q");
    } else if (selectedPhase === "1.0r") {
      filteredCommands = COMMANDS_BASELINE.filter(c => c.phase === "0.3j" || c.phase === "0.3k" || c.phase === "0.3l" || c.phase === "0.3m" || c.phase === "0.3n" || c.phase === "0.3o" || c.phase === "0.3p" || c.phase === "0.3q" || c.phase === "0.3r" || c.phase === "0.3s" || c.phase === "1.0a" || c.phase === "1.0b" || c.phase === "1.0c" || c.phase === "1.0d" || c.phase === "1.0e" || c.phase === "1.0f" || c.phase === "1.0g" || c.phase === "1.0h" || c.phase === "1.0i" || c.phase === "1.0i-loop" || c.phase === "1.0j" || c.phase === "1.0k" || c.phase === "1.0l" || c.phase === "1.0m" || c.phase === "1.0n" || c.phase === "1.0o" || c.phase === "1.0p" || c.phase === "1.0q" || c.phase === "1.0r");
    } else if (selectedPhase === "1.0s") {
      filteredCommands = COMMANDS_BASELINE.filter(c => c.phase === "0.3j" || c.phase === "0.3k" || c.phase === "0.3l" || c.phase === "0.3m" || c.phase === "0.3n" || c.phase === "0.3o" || c.phase === "0.3p" || c.phase === "0.3q" || c.phase === "0.3r" || c.phase === "0.3s" || c.phase === "1.0a" || c.phase === "1.0b" || c.phase === "1.0c" || c.phase === "1.0d" || c.phase === "1.0e" || c.phase === "1.0f" || c.phase === "1.0g" || c.phase === "1.0h" || c.phase === "1.0i" || c.phase === "1.0i-loop" || c.phase === "1.0j" || c.phase === "1.0k" || c.phase === "1.0l" || c.phase === "1.0m" || c.phase === "1.0n" || c.phase === "1.0o" || c.phase === "1.0p" || c.phase === "1.0q" || c.phase === "1.0r" || c.phase === "1.0s");
    } else if (selectedPhase === "1.0t") {
      filteredCommands = COMMANDS_BASELINE.filter(c => c.phase === "0.3j" || c.phase === "0.3k" || c.phase === "0.3l" || c.phase === "0.3m" || c.phase === "0.3n" || c.phase === "0.3o" || c.phase === "0.3p" || c.phase === "0.3q" || c.phase === "0.3r" || c.phase === "0.3s" || c.phase === "1.0a" || c.phase === "1.0b" || c.phase === "1.0c" || c.phase === "1.0d" || c.phase === "1.0e" || c.phase === "1.0f" || c.phase === "1.0g" || c.phase === "1.0h" || c.phase === "1.0i" || c.phase === "1.0i-loop" || c.phase === "1.0j" || c.phase === "1.0k" || c.phase === "1.0l" || c.phase === "1.0m" || c.phase === "1.0n" || c.phase === "1.0o" || c.phase === "1.0p" || c.phase === "1.0q" || c.phase === "1.0r" || c.phase === "1.0s" || c.phase === "1.0t");
    } else if (selectedPhase === "1.0u") {
    ...
    } else if (selectedPhase === "1.0x") {
      filteredCommands = COMMANDS_BASELINE.filter(c => c.phase === "0.3j" || c.phase === "0.3k" || c.phase === "0.3l" || c.phase === "0.3m" || c.phase === "0.3n" || c.phase === "0.3o" || c.phase === "0.3p" || c.phase === "0.3q" || c.phase === "0.3r" || c.phase === "0.3s" || c.phase === "1.0a" || c.phase === "1.0b" || c.phase === "1.0c" || c.phase === "1.0d" || c.phase === "1.0e" || c.phase === "1.0f" || c.phase === "1.0g" || c.phase === "1.0h" || c.phase === "1.0i" || c.phase === "1.0i-loop" || c.phase === "1.0j" || c.phase === "1.0k" || c.phase === "1.0l" || c.phase === "1.0m" || c.phase === "1.0n" || c.phase === "1.0o" || c.phase === "1.0p" || c.phase === "1.0q" || c.phase === "1.0r" || c.phase === "1.0s" || c.phase === "1.0t" || c.phase === "1.0u" || c.phase === "1.0v" || c.phase === "1.0w" || c.phase === "1.0x");
    } else if (selectedPhase === "1.0y") {
      filteredCommands = COMMANDS_BASELINE.filter(c => c.phase === "0.3j" || c.phase === "0.3k" || c.phase === "0.3l" || c.phase === "0.3m" || c.phase === "0.3n" || c.phase === "0.3o" || c.phase === "0.3p" || c.phase === "0.3q" || c.phase === "0.3r" || c.phase === "0.3s" || c.phase === "1.0a" || c.phase === "1.0b" || c.phase === "1.0c" || c.phase === "1.0d" || c.phase === "1.0e" || c.phase === "1.0f" || c.phase === "1.0g" || c.phase === "1.0h" || c.phase === "1.0i" || c.phase === "1.0i-loop" || c.phase === "1.0j" || c.phase === "1.0k" || c.phase === "1.0l" || c.phase === "1.0m" || c.phase === "1.0n" || c.phase === "1.0o" || c.phase === "1.0p" || c.phase === "1.0q" || c.phase === "1.0r" || c.phase === "1.0s" || c.phase === "1.0t" || c.phase === "1.0u" || c.phase === "1.0v" || c.phase === "1.0w" || c.phase === "1.0x" || c.phase === "1.0y");
    }
  }
